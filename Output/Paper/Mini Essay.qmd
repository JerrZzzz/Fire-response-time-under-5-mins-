...
I am interested in a data set called "Traffic Cameras". Next step is to get the package itself, and let's look at the top 6 rows of the dataset.
...
Second, choose only the column called incident_station_area, tfs-alarm-time and tfs_arrival_time. Then, my dataset would be much easier to look.
...
Since that our dataset has a lot of data points, a scatter plot would be a good choice. 
